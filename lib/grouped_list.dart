...
class GroupedListView<T, E> extends StatefulWidget {
    ...
    final bool didInstallPullRefreshWidget;
    ...
    GroupedListView({
        ...
        this.itemExtent,
        this.didInstallPullRefreshWidget = false,
...
class _GroupedListViewState<T, E> extends State<GroupedListView<T, E>> {
    ...
    Widget build(BuildContext context) {
        ...
        return Stack(
            ...
            children: <Widget>[
                widget.didInstallPullRefreshWidget ? _buildRefrashWidget(listView) : listView,
                StreamBuilder<int>(
    ...
    Widget _buildRefrashWidget(Widget child) {
